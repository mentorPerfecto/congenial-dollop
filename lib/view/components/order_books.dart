...
class OrderBooks extends ConsumerStatefulWidget {
  const OrderBooks({super.key});

  @override
  ConsumerState<OrderBooks> createState() => _OrderBooksState();
}

class _OrderBooksState extends ConsumerState<OrderBooks> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        ...
        final currentLimit = provider.currentLimit;
        final orderBook = provider.orderBook;
        final symbolsPairs = provider.symbols;
        double? highestBid;
        double? lowestAsk;
        double? diffHigLow;
        if (orderBook != null) {
