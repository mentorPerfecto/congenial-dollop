            ...
            Expanded(
              child: Stack(
                children: [
                  Candlesticks(
                      key: Key(
                          '${provider.currentTicker?.symbol}${provider.currentInterval}'),
                      candles: candles,
                      onLoadMoreCandles: provider.fetchMoreCandles),
                  if (ticker != null) ...[
                    Container(
                      height: 16,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListenableBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        ...
        final intervals = provider.intervals;
        final currentInterval = provider.currentInterval;
        return Row(
          ...
          children: [
            ...
            DropdownView(
                ...
                onChanged: (value) => provider.setInterval(value!)),
            _divider(),
